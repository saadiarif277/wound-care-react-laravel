...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('canonical_fields', function (Blueprint $table) {
            ...
            $table->string('field_path'); // Full path in canonical structure
        ...
        Schema::create('template_field_mappings', function (Blueprint $table) {
            $table->id();
            $table->foreignId('template_id')->constrained('docuseal_templates')->onDelete('cascade');
