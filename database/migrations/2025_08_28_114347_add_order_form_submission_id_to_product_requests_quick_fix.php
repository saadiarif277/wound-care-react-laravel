...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('product_requests', function (Blueprint $table) {
            // Add order form submission tracking columns if they don't exist
            if (!Schema::hasColumn('product_requests', 'order_form_submission_id')) {
                $table->string('order_form_submission_id')->nullable()->after('docuseal_submission_id');
            }
            if (!Schema::hasColumn('product_requests', 'order_form_submitted_at')) {
