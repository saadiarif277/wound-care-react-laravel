...
const INSURANCE_PRODUCT_RULES = {
  'ppo': {
    allowedProducts: ['Q5128'], // BioVance
  ...
  'medicare': {
    '0-250': {
      allowedProducts: ['Q5230', 'Q5231'], // AmnioAMP, Membrane Wrap Hydro
      message: 'Medicare covers AmnioAMP or Membrane Wrap Hydro for wounds 0-250 sq cm'
    },
    '251-450': {
      allowedProducts: ['Q5231'], // Membrane Wrap Hydro only
  ...
  'medicaid': {
    ...
    defaultProducts: ['Q5129', 'Q5128', 'Q5127'] // EpiFix, BioVance, AmnioBand
  }
};
...
const MUE_LIMITS: Record<string, number> = {
  'Q5128': 4000, // BioVance
  'Q5129': 4000, // EpiFix
  'Q5127': 4000, // AmnioBand
  'Q5230': 4000, // AmnioAMP
  'Q5231': 4000, // Membrane Wrap Hydro
  'Q5232': 4000, // Membrane Wrap
  'Q5233': 4000  // Restorigen
};
...
const ProductSelectorQuickRequest: React.FC<Props> = ({
  ...
  useEffect(() => {
    ...
    selectedProducts.forEach(item => {
      ...
      if (product) {
        ...
        // Check MUE limits
        const totalSize = selectedProducts
  ...
  }, [selectedProducts, products, last24HourOrders]);
            ...
            <div className={`${t.glass.card} rounded-lg p-4 sticky top-4`}>
              ...
              {selectedProducts.length === 0 ? (
                <div className="text-center py-8">
                  <Package className={`w-12 h-12 mx-auto mb-3 ${t.text.muted}`} />
                  <p className={`${t.text.secondary} mb-2`}>
