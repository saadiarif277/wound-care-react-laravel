...
import { FiArrowLeft, FiSave, FiUser, FiMapPin, FiCreditCard, FiMail } from 'react-icons/fi';
      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-bold text-gray-900">Create Provider</h1>
            <p className="mt-1 text-gray-600">Add a new healthcare provider to the system</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="p-6">
              ...
              <div className="mt-4">
                ...
                <p className="mt-2 text-sm text-gray-600">
                  Check this if the provider's credentials have been manually verified. Otherwise, verification will be done through the credential management system.
                </p>
              </div>
            </div>
          </Card>
          ...
          <Card>
            <div className="p-6">
              ...
              <p className="mt-2 text-sm text-gray-600">
                You can assign facilities and manage credentials after creating the provider account.
              </p>
            </div>
          </Card>
