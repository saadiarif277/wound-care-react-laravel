...
final class ProductRequestController extends Controller
{
    ...
    public function show(ProductRequest $productRequest)
    {
        ...
        // Redirect to the unified order details system based on user role
        $userRole = $user->getPrimaryRole()?->slug ?? 'admin';
        $routeContext = $this->determineRouteContext($userRole);
        
        // Use the unified order details route
        return redirect()->route("{$routeContext}.orders.show", $productRequest->id);
    }
