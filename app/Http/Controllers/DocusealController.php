...
/**
 * DocusealController - Handles DocuSeal operations for admin/order management
 * 
 * This controller handles DocuSeal operations related to order management
 * and admin functions. For Quick Request workflow DocuSeal operations,
 * use QuickRequest\DocusealController instead.
 * 
 * @see \App\Http\Controllers\QuickRequest\DocusealController
 */
class DocusealController extends Controller
{
    ...
    // Note: generateSubmissionSlug method has been moved to QuickRequest\DocusealController
    // All quick request DocuSeal operations should use that controller
    ...
    // Note: Episode creation and data extraction methods have been moved to QuickRequest\DocusealController
    // This controller should focus on admin/order-related DocuSeal operations only
