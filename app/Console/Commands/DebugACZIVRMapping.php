...
class DebugACZIVRMapping extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'debug:acz-ivr-mapping {--data=}';
     ...
     * @var string
     */
    protected $description = 'Debug ACZ IVR field mapping to identify missing fields';
    ...
    public function handle()
    {
        ...
        $this->info('=== ACZ IVR Field Mapping Debug ===');
        $this->newLine();
