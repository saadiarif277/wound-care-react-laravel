...
class DebugCelularityBiovanceIVRMapping extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'debug:celularity-biovance-ivr-mapping {--data=}';
     ...
     * @var string
     */
    protected $description = 'Debug Celularity Biovance IVR field mapping to identify missing fields';
    ...
    public function handle()
    {
        ...
        $this->info('=== Celularity Biovance IVR Field Mapping Debug ===');
        $this->newLine();

        $result = $docusealService->debugCelularityBiovanceIVRMapping($formData);
