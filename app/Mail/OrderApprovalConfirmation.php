...
class OrderApprovalConfirmation extends Mailable
{
    ...
    {
        return new Envelope(
            subject: "MSC Wound Care - Order #{$this->order->request_number} Approved",
    ...
    {
        return new Content(
            markdown: 'emails.order-approval-confirmation',
            with: [
                'order' => $this->order,
