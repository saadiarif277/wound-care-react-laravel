...
return [
    ...
    'fields' => [
        ...
        'place_of_service' => [
            ...
            'required' => true,
            'type' => 'string'
            // Values should be exact: "POS 11", "POS 12", "POS 22", "POS 24", etc.
        ],
        'pos_other_specify' => [
        ...
        'patient_name' => [
            'source' => 'computed',
            'computation' => '(patient_first_name && patient_last_name) ? patient_first_name + " " + patient_last_name : (fhir_patient_first_name && fhir_patient_last_name ? fhir_patient_first_name + " " + fhir_patient_last_name : (patient_name || ""))',
            'required' => true,
            'type' => 'string'
        ],
        'patient_dob' => [
        ...
        'primary_insurance_name' => [
            'source' => 'primary_insurance_name || insurance_name || primary_payer_name',
            'required' => false,
            'type' => 'string'
        ],
