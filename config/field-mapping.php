    ...
    'manufacturers' => [
        ...
        'Centurion Therapeutics' => [
            ...
            'fields' => [
                ...
                'facility_contact' => [
                    'source' => 'facility_contact_name || office_contact_name',
                    'required' => false,
                    'type' => 'string'
                ],
                'facility_contact_phone' => [
                    'source' => 'facility_contact_phone || office_contact_phone',
                    'transform' => 'phone:US',
                    'required' => false,
                    'type' => 'phone'
                ],
                'facility_contact_fax' => [
                    'source' => 'facility_contact_fax || office_contact_fax',
                    'transform' => 'phone:US',
                    'required' => false,
                    'type' => 'phone'
                ],
                'facility_contact_email' => [
                    'source' => 'facility_contact_email || office_contact_email',
                    'required' => false,
                    'type' => 'email'
                ],
                
                // Place of Service Checkboxes - using string comparisons per IVR rules
                'pos_22' => [
                    'source' => 'computed',
