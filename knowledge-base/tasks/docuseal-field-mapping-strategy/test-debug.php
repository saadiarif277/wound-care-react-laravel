...
/**
 * Test script to debug ACZ IVR field mapping
 *
 * This script demonstrates the debugging functionality to identify
 * which fields are missing from form data and how to improve mapping.
 */
...
echo "=== ACZ IVR Field Mapping Debug Test ===\n\n";
...
echo "==========================\n";
$missingAnalysis = $report['missing_fields_analysis'] ?? [];
foreach ($missingAnalysis as $missing) {
    echo "\n❌ Missing: {$missing['docuseal_field']}\n";
    echo "   Source Fields: " . implode(', ', $missing['source_fields']) . "\n";
    echo "   Available Sources: " . implode(', ', $missing['available_sources']) . "\n";
    echo "   Missing Sources: " . implode(', ', $missing['missing_sources']) . "\n";
    echo "   Required: " . ($missing['required'] ? 'YES' : 'NO') . "\n";
...
if ($result['success']) {
    ...
    echo "📋 Review the missing fields analysis above.\n";
    echo "🔧 Consider adding the missing data sources to your form.\n";
}

echo "\n🚀 NEXT STEPS:\n";
echo "==============\n";
echo "1. Check the missing fields analysis above\n";
echo "2. Add missing data sources to your form\n";
echo "3. Test with real form submissions\n";
echo "4. Monitor success rates in production\n";
